...
def main(input_dl3_file, output, threshold, multiplicity, complementary):
    ...
    #b_68, bin_edges, binnumber = binned_statistic(x, y, statistic=lambda y: np.nanpercentile(y, 68), bins=bins)
