...
def main(input_files, output, threshold, reference, complementary):
    columns = ['mc_alt', 'mc_az', 'mc_energy', 'az_prediction', 'alt_prediction', 'num_triggered_telescopes']

    if threshold > 0:
        columns.extend('gamma_prediction_mean')
    ...
    for input_file in input_files:
        ...
        plt.step(bin_center, b_68, lw=2, label=input_file, where='mid')
